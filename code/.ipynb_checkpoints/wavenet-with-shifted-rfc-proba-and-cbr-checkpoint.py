...
def read_data():
    ...
    Y_train_proba_lgb = np.load("oof_train/oof_train_lgb940.npy")
    Y_test_proba_lgb = np.load("oof_test/oof_test_lgb940.npy")
    
    
    train['proba_lgb940'] = Y_train_proba_lgb
    test['proba_lgb940'] = Y_test_proba_lgb
...
def run_feat_engineering(df, batch_size):
    ...
    df = lag_with_pct_change(df, [1, 2, 3, 50 , 100])
