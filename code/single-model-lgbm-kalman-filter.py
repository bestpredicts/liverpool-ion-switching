...
oof_train,round_y_pred = run_lgb(pre_train, pre_test, features, params)
...
np.save("oof_train/oof_train_lgb940.npy",oof_train)

np.save("oof_test/oof_test_lgb940.npy",round_y_pred)
